...
class dbHelper(context: Context):SQLiteOpenHelper(context,"myData",null,2) {
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE TABLE DEVICE_HISTORY(DEVICE_ID VARCHAR2,EMP_MAIL VARCHAR2,START_TIME VARCHAR2,END_TIME VARCHAR2)")
    }
